...
public final class ViewPropertyAnimatorCompat {
    ...
    interface ViewPropertyAnimatorCompatImpl {
        ...
        /* renamed from: x */
        void mo2601x(ViewPropertyAnimatorCompat viewPropertyAnimatorCompat, View view, float f);

        void xBy(ViewPropertyAnimatorCompat viewPropertyAnimatorCompat, View view, float f);

        /* renamed from: y */
        void mo2603y(ViewPropertyAnimatorCompat viewPropertyAnimatorCompat, View view, float f);

        void yBy(ViewPropertyAnimatorCompat viewPropertyAnimatorCompat, View view, float f);

        /* renamed from: z */
        void mo2605z(ViewPropertyAnimatorCompat viewPropertyAnimatorCompat, View view, float f);
    ...
    static class BaseViewPropertyAnimatorCompatImpl implements ViewPropertyAnimatorCompatImpl {
        ...
        /* renamed from: x */
        public void mo2601x(ViewPropertyAnimatorCompat vpa, View view, float value) {
            postStartMessage(vpa, view);
        }
        ...
        /* renamed from: y */
        public void mo2603y(ViewPropertyAnimatorCompat vpa, View view, float value) {
            postStartMessage(vpa, view);
        }
        ...
        /* renamed from: z */
        public void mo2605z(ViewPropertyAnimatorCompat vpa, View view, float value) {
        }
    ...
    /* renamed from: x */
    public ViewPropertyAnimatorCompat mo2564x(float value) {
        View view = (View) this.mView.get();
        if (view != null) {
            IMPL.mo2601x(this, view, value);
        }
        return this;
    }
    ...
    /* renamed from: y */
    public ViewPropertyAnimatorCompat mo2566y(float value) {
        View view = (View) this.mView.get();
        if (view != null) {
            IMPL.mo2603y(this, view, value);
        }
        return this;
    }
    ...
    /* renamed from: z */
    public ViewPropertyAnimatorCompat mo2568z(float value) {
        View view = (View) this.mView.get();
        if (view != null) {
            IMPL.mo2605z(this, view, value);
        }
        return this;
    }
