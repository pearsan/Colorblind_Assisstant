...
class AlertController {
    ...
    public AlertController(Context context, AppCompatDialog di, Window window) {
        ...
        TypedArray a = context.obtainStyledAttributes((AttributeSet) null, C0191R.styleable.AlertDialog, C0191R.attr.alertDialogStyle, 0);
    ...
    private void setupView() {
        ...
        if (!(hasButtonPanel || contentPanel == null || (spacer = contentPanel.findViewById(C0191R.C0193id.textSpacerNoButtons)) == null)) {
