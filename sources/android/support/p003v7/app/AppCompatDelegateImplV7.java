    ...
    private ViewGroup createSubDecor() {
        ...
        if (this.mWindowNoTitle) {
            if (this.mOverlayActionMode) {
                subDecor = (ViewGroup) inflater.inflate(C0191R.layout.abc_screen_simple_overlay_action_mode, (ViewGroup) null);
            } else {
                subDecor = (ViewGroup) inflater.inflate(C0191R.layout.abc_screen_simple, (ViewGroup) null);
            }
            ...
            subDecor = (ViewGroup) inflater.inflate(C0191R.layout.abc_dialog_title_material, (ViewGroup) null);
            ...
            subDecor = (ViewGroup) LayoutInflater.from(themedContext).inflate(C0191R.layout.abc_screen_toolbar, (ViewGroup) null);
        ...
        ContentFrameLayout abcContent = (ContentFrameLayout) subDecor.findViewById(C0191R.C0193id.action_bar_activity_content);
        ...
        if (mode != null) {
            ...
            if (this.mActionModeView == null) {
                if (this.mIsFloating) {
                    ...
                    this.mActionModePopup = new PopupWindow(actionBarContext, (AttributeSet) null, C0191R.attr.actionModePopupWindowStyle);
